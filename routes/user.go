...
func logIn(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "No se pudo autenticar usuario", "error": err.Error()})
		return
	}

	context.JSON(http.StatusOK, gin.H{"message": "Login Exitozo!", "token": token})
